...
/**
 * The ContactsAllPanel class is used in the ContactsPanel class to display and
 * manipulate all <code>Contact</code> objects in the application.
 * 
